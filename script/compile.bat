set PATH=%ffmpeg_installed_dir%\ffmpeg-20191224-287620f-win64-shared\bin;C:\Program Files (x86)\IntelSWTools\openvino\deployment_tools\inference_engine\bin\intel64\Release;%PATH%
